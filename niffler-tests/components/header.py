...
class HeaderComponent:
    ...
    def is_new_spending_button_visible(self):
    ...
    def is_profile_menu_visible(self):
        """Проверка что все пункты меню профиля видимы"""
        return (self.PROFILE_MENU_PROFILE.is_visible() and
                self.PROFILE_MENU_FRIENDS.is_visible() and
                self.PROFILE_MENU_ALL_PEOPLE.is_visible() and
                self.PROFILE_MENU_SIGN_OUT.is_visible())
