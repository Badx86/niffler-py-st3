...
class CurrencyFilterComponent:
    ...
    def are_all_options_visible(self):
        ...
        return (self.CURRENCY_OPTION_ALL.is_visible() and
                self.CURRENCY_OPTION_RUB.is_visible() and
                self.CURRENCY_OPTION_KZT.is_visible() and
                self.CURRENCY_OPTION_EUR.is_visible() and
                self.CURRENCY_OPTION_USD.is_visible())
