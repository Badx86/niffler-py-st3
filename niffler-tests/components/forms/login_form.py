...
class LoginFormComponent:
    ...
    def enter_password_submit(self, password):
    ...
    def is_error_displayed(self):
        ...
        return ("?error" in self.page.url and
                self.page.locator(".form__error-container").is_visible())

    def is_success_message_displayed(self):
        """Проверяем появилось ли сообщение об успешной регистрации"""
        return self.page.locator('text="Congratulations! You\'ve registered!"').is_visible()
